...
private static ExtentReports extent;
    ...
    public synchronized static ExtentReports getReporter(String filePath) {
        ...
        if (extent == null) {
            ...
            extent = new ExtentReports(filePath, true,DisplayOrder.NEWEST_FIRST, NetworkMode.ONLINE, Locale.CANADA_FRENCH);
            extent
                .addSystemInfo("Host Name", hostname)
                .addSystemInfo("Environment", SUTprop.getProperty("enviornment"))
            	.addSystemInfo("Broswer", SUTprop.getProperty("BROWSER"));      
        }
       return extent;
    }
		return extent;
